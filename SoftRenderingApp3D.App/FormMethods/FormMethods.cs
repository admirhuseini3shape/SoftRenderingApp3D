...
namespace SoftRenderingApp3D.App.FormMethods {
    public class FormMethods {
        ...
        public List<DisplayModelJsonData> DeserializeAllModelConfigs(string directoryPath)
        {
            ...
            List<DisplayModelJsonData> models = new List<DisplayModelJsonData>();

            foreach (string jsonFile in Directory.GetFiles(directoryPath, "*.json"))
            {
                DisplayModelJsonData model = deserializer.DeserializeObjectFromFile(jsonFile);
                models.Add(model);
        ...
        public World prepareWorld(string id, ArcBallCam arcBallCam, CheckBox chkShowTexture, Panel3D panel3D1) {
            ...
            List<DisplayModelJsonData> models = DeserializeAllModelConfigs("C:\\Users\\Saiti\\RiderProjects\\SoftRenderingApp3D\\SoftRenderingApp3D.App\\JsonData");
