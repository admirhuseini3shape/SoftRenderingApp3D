...
namespace SubsurfaceScatteringLibrary.Painter {
    class SubsurfaceScatteringPainterUtils {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void SortTrianglePoints(VertexBuffer vbx, SubsurfaceScatteringFrameBuffer frameBuffer, int triangleIndices, out PaintedVertex v0, out PaintedVertex v1, out PaintedVertex v2, out int index0, out int index1, out int index2) {
