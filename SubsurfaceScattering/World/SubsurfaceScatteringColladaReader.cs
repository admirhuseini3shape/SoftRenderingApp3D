...
namespace SubsurfaceScattering.World {
    public class SubsurfaceScatteringColladaReader : SubsurfaceScatteringFileReader {
        // Work in progress

        public static IEnumerable<SubsurfaceScatteringVolume> NewImportCollada(string fileName) {
            ...
            foreach(var geometry in geometries) {
                ...
                if(polylist != null) {
                    ...
                    yield return new SubsurfaceScatteringVolume(
